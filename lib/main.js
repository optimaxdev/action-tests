...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { gitHubToken, flagsOnRelatedRun } = getOptions_1.getOptions();
        ...
        const isRunningAllTests = prChangedFiles.length > 100 || files_js_1.isRootFilesTouched(prChangedFiles) || testableFiles.length === 0;
        ...
        return yield jest_1.runJestTests([...flagsOnRelatedRun, '--findRelatedTests', ...testableFiles]);
    });
}
