        ...
        try {
            ...
            if (context.payload.pull_request) {
                ...
                function runAllTests() {
                    return __awaiter(this, void 0, void 0, function* () {
                        yield exec.exec('npm run', ['test', ...flags, ...reportersCMD], exacOptions);
                    });
                }
                if (changed_files > 100) {
                    ...
                    if (utils_1.getIsRunAllTests(files)) {
                        ...
                        yield exec.exec('jest', [...flags, fileNames.length > 0 ? '--findRelatedTests' : '', ...fileNames, ...reportersCMD], exacOptions);
                    }
                }
            }
            else {
